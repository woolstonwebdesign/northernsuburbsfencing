...
function wwd_load_scripts() {
    ...
    wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css?family=Roboto:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700;', array(), '1.0', 'all');
    ...
    wp_enqueue_style('wwd-core-css', get_template_directory_uri() . '/css/style.min.css', array(), '0.0.68', 'all');
    ...
    wp_enqueue_script('wwd-core-js', get_template_directory_uri() . '/js/core.min.js', array('jquery'), '0.0.68', true);
}
